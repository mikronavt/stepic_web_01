...
echo "http://localhost/hello/?a=1&a=2&b=3"
curl -I "http://localhost/hello/?a=1&a=2&b=3"
echo "http://localhost:8080/?a=1&a=2&b=3"
curl -I "http://localhost:8080/?a=1&a=2&b=3"